...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-[1.75rem] border border-white/70 bg-card shadow-[0_20px_55px_-36px_rgba(67,73,54,0.35)] backdrop-blur-sm dark:border-white/10 dark:shadow-[0_24px_60px_-40px_rgba(0,0,0,0.8)]",
        className,
      )}
      {...props}
    />
